...
Go to the Attendance-System folder and run
...
The username is their name and password for everyone is '14egco733'.

Example usernames:
student- 'edidiong'
teacher- 'trisila'

You can access the django admin page at **http://127.0.0.1:8000/admin** and login with username 'edeediong' and the above password.
